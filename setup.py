...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-entity-base',
    project_urls={
        'Documentation': 'https://tendril-entity-base.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-entity-base/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-entity-base',
    },
